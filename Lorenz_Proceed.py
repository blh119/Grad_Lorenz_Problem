...
def nudged_system(tf, step):
    ...
    for time_step in time_steps:
        ...
        if counter == 0:
            ...
            init_ndg_y = ndg_full_set[counter-1][step-1][1]
...
def plot_absolute_errors(sol_endpoints, ndg_endpoints, sol_g_endpoints, ndg_g_endpoints):
    ...
    plt.title('Evolution of absolute errors'); plt.xlabel('t = 1000 td = 1 mu = 1000'); plt.yscale('log')
    plt.legend(); plt.grid(); plt.tight_layout()
    plt.show()

sol, ndg, sol_g, ndg_g = nudged_system(1000, 1)
